...
""" get data """
#X, Y = get_data("Data/movies.csv", header=True)
...
X_train, Y_train = get_data("Data/hec_train.csv", header=True)
X_train	= X_train[:,1:]
X_val, Y_val = get_data("Data/hec_validation.csv", header=True)
X_val	= X_val[:,1:]
X_test, Y_test = get_data("Data/hec_test.csv", header=True)
X_test	= X_test[:,1:]
